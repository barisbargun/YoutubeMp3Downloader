    ...
    internal class OpeningMp3Downloader
    {
        ...
        private bool SearchVideo()
        {
            return CheckingElement<bool>.CheckElement<String>
                (driver, (int)StepDownloaderConstants.StepDownloader.MP3_SEARCH_VIDEO, url);
        }
        ...
        private bool DownloadMp3Video()
        {
            if (
                ...
                (driver, (int)StepDownloaderConstants.StepDownloader.MP3_DOWNLOAD_VIDEO_ROAD2, url)
                )
            {
                return CheckingElement<bool>.CheckElement<String>
                (driver, (int)StepDownloaderConstants.StepDownloader.MP3_DOWNLOAD_VIDEO_ROAD3, url);
            }
            else if (
                CheckingElement<bool>.CheckElement<String>
                (driver, (int)StepDownloaderConstants.StepDownloader.MP3_DOWNLOAD_VIDEO_ROAD1, url) &&
                CheckingElement<bool>.CheckElement<String>
                (driver, (int)StepDownloaderConstants.StepDownloader.MP3_DOWNLOAD_VIDEO_ROAD2, url)
                )
            {
